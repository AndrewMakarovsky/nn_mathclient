...
namespace parsexml
{
	...
	class root_tag_not_exist : public exception
	{
		string info;
	public:
		root_tag_not_exist(string e = "xml файл не имеет корневого тега") : info(e) {}
	...
	class xml_struct_is_wrong : public exception
	{
		string info;
	public:
		xml_struct_is_wrong(string path, string e = "неправильная структура xml файла")
		{
			info.append("Текущий путь: ");
			info.append(path);
			info.append(", ");
			info.append(e);
		}
	...
	class xml_close_tag_wrong : public exception
	{
		string info;
	public:
		xml_close_tag_wrong(string path, string e = "неправильная структура xml файла: закрывается тег, который не был открыт")
		{
			info.append("Текущий путь: ");
			info.append(path);
			info.append(", ");
